    ...
    private void btnĐangKyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnĐangKyActionPerformed
        ...
        if (MaNhanVien.equals("")) {
            ...
            if (TenDangNhap.length() < 6 || TenDangNhap.length() > 20) {
                ThongBao("Tên đăng nhập phải từ 6-20 ký tự", "Thông báo lỗi", JOptionPane.ERROR_MESSAGE);
            } else if (Password.length() < 6 || Password.length() > 20) {
                ThongBao("Mật khẩu phải nhập nhiều hơn 6 ký tự và ít hơn 20 kí tự", "Lỗi đăng ký", 2);
                ...
                ResultSet rs2 = pldk21t1020041.PLDK21t1020041.connection.ExcuteQueryGetTable(cautruyvan2);
                try {
                    rs2.next();
                ...
                if (kt == true) {
                 String ctv = "INSERT INTO Users (MaNhanVien, TenDangNhap, Password, Quyen) VALUES (" 
            + MaNhanVien + ", '" 
            + TenDangNhap + "', '" 
            + Password + "', " 
            + Quyen + ")";
    ...
    private void btnDangNhapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDangNhapActionPerformed
        ...
        if(strUsername.equals("")){
           ...
           if (KiemTra(strUsername, strPassword)) {
            pldk21t1020041.PLDK21t1020041.frmTC.show();
            this.dispose();
        } else {
